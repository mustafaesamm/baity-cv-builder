import { version, unref, inject, defineComponent, provide, shallowReactive, h, ref, watch, Suspense, nextTick, Fragment, Transition, hasInjectionContext, getCurrentInstance, readonly, useSSRContext, createApp, effectScope, reactive, getCurrentScope, onMounted, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, defineAsyncComponent, mergeProps, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, markRaw } from 'vue';
...
const _routes = [
  {
    name: "form",
    path: "/form",
    component: () => import('./form-D-bk5iwt.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-DPGLjt4H.mjs')
  },
  {
    name: "pdf",
    path: "/pdf",
    component: () => import('./pdf-NNLQc1F_.mjs')
  },
  {
    name: "pdfFile",
    path: "/pdfFile",
    component: () => import('./pdfFile-mmO2Y63f.mjs')
  },
  {
    name: "schemas",
    path: "/schemas",
    component: () => import('./schemas-2o0C9wgz.mjs')
  },
  {
    name: "test",
    path: "/test",
    component: () => import('./test-0a99_qCY.mjs')
  },
  {
    name: void 0 ,
    path: "/word",
    component: () => import('./word-CJy2pUTg.mjs'),
    children: [
      {
        name: "word",
        path: "",
        component: () => import('./word-BLWk5Qei.mjs')
      }
    ]
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DaZox2Z-.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DLMaiBX5.mjs'));
...
export { BaseStyle as B, PrimeVueService as P, _export_sfc as _, resolveRouteObject as a, navigateTo as b, useNuxtApp as c, useRuntimeConfig as d, entry$1 as default, injectHead as i, nuxtLinkDefaults as n, resolveUnrefHeadInput as r, useRouter as u };
